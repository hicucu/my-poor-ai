...
# 1. Create in my-poor-ai location (lowest priority)
...
# Test 2: Document personal vs bundled my-poor-ai priority
echo ""
echo "Test 2: Documenting personal vs my-poor-ai priority..."
...
describe_priority_result \
    ...
    "Current OpenCode behavior loaded bundled my-poor-ai version instead of personal version"

# Test 3: Document project vs bundled my-poor-ai priority
echo ""
echo "Test 3: Documenting project vs personal/my-poor-ai priority..."
...
describe_priority_result \
    ...
    "Current OpenCode behavior loaded bundled my-poor-ai version instead of project version"

# Test 4: Test a non-colliding bundled my-poor-ai skill is still available
echo ""
echo "Test 4: Testing non-colliding my-poor-ai skill remains available..."

mkdir -p "$FORGE_SKILLS_DIR/my-poor-ai-only-test"
cat > "$FORGE_SKILLS_DIR/my-poor-ai-only-test/SKILL.md" <<'EOF'
---
name: my-poor-ai-only-test
...
run_opencode output "$TEST_HOME/test-project" "Call the skill tool with name \"my-poor-ai-only-test\". Show the exact content including any PRIORITY_MARKER text."
assert_contains "$output" "PRIORITY_MARKER_FORGE_ONLY_VERSION" "Non-colliding my-poor-ai skill is still registered"
