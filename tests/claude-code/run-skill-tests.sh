...
while [[ $# -gt 0 ]]; do
    case $1 in
        ...
        --help|-h)
            ...
            echo "  test-requesting-code-review.sh  Code reviewer subagent catches planted bugs"
            echo "  test-worktree-native-preference.sh  Native worktree tool preference (RED/GREEN/PRESSURE)"
            exit 0
            ;;
        *)
