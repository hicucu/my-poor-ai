...
mkdir -p src test docs/my-poor-ai/plans

# Create a simple implementation plan
cat > docs/my-poor-ai/plans/implementation-plan.md <<'EOF'
...
I want you to execute the implementation plan at docs/my-poor-ai/plans/implementation-plan.md using the subagent-driven-development skill.
...
PROMPT="Execute the implementation plan at docs/my-poor-ai/plans/implementation-plan.md using the subagent-driven-development skill.
...
if grep -q '"name":"Skill".*"skill":"my-poor-ai:subagent-driven-development"' "$SESSION_FILE"; then
